...
from webscrapper.terminal.terminal_service import TerminalProductService, TerminalShopService
...
class MyApp:
    def __init__(self, stdscreen):
        ...
        self.shop_service = TerminalShopService(self.session, self.screen)
        self.product_service = TerminalProductService(self.session, self.screen)
